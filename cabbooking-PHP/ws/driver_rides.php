                        ...
                        <?php if ($count > 0) {
                            ...
                            <div class="form">
                                <form method="post" action="">
                                    <!-- --Changes by KKB on 17 April 2015 -- -->
                                    <input type="text" name="ride_amount" class="text r_amount" value="" placeholder="Enter Fare amount" style="width:100%"/>
                                    ...
                                    <div class="all-button update-payment" style="padding-top: 10px;">
                                        <input type="submit" value="" data-theme="upb" name='update_payment' id="update_payment" style="width: 180px;height: 45px;"/>
                                    </div>
                                    <!-- --Changes by KKB on 17 April 2015 -- -->
                                </form>
