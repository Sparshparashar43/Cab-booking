...
<tr>
	...
	<tr>
		...
		<td class="lightGrayBg"><input name="product_price" size="8" type="text" value="<?=$product_price?>" />&nbsp;<strong>US$</strong></td>
	</tr>
	<tr><td class='tdLabel' colspan='2'>&nbsp;</td></tr>
	<tr>
		<td class="lightGrayBg" valign="top" nowrap>Sale Price <span class="star">*</span></td>
		<td class="lightGrayBg"><input name="sale_price" size="8" type="text" value="<?=$sale_price?>" />&nbsp;<strong>US$</strong></td>
	</tr>
	<tr><td class='tdLabel' colspan='2'>&nbsp;</td></tr>
	<tr>
