...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td id="pageHead"><div id="txtPageHead">Manage Driver</div></td>
    </tr>
</table>
                    ...
                    <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="tableList">
                        ...
                        while ($line_raw = ms_stripslashes(mysql_fetch_array($result))) {
                            ...
                            <tr class="<?= $css ?>">
                                ...
                                <td align="center" valign="top"><a href="driver_add.php?id=<?= $line_raw['id'] ?>&set_flag=update<?= $_REQUEST[parent_id] != '' ? '&parent_id=' . $_REQUEST[parent_id] : '' ?>"><img src="images/icons/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td>
                                <td align="left" valign="top"><?= stripslashes($line_raw['fullname']); ?><br />
                                    <a href='javascript:;' onClick="window.open('view_driver.php?did=<?= $line_raw['id']; ?>', '_blank', 'toolbar=no,menubar=no,scrollbars=yes,resizable=1,height=500,width=750');">View All</a></td>
